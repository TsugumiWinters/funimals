...
tutorialStep = window.localStorage.getItem("bookTutorialStep");
...
function initApp() {
	if (tutorialMode == "true") {
		...
		photoImg.src="images/Users/"+window.localStorage.getItem("userID")+".jpg";
		//auto-resize text
	...
	next.onclick = function () {
		...
		window.localStorage.setItem("storiesTutorialStep", 0);
	...
	skip.onclick = function () {
		...
		window.Connector.changeActivity(user, parseInt(window.localStorage.getItem('userAge')), parseInt(window.localStorage.getItem('userGrade')), 0);
	};
...
function tutorialStepFunc() {
	...
	switch(tutorialStep) {
		...
		case 1: tutorialBox.style.height = "23.3333%";
				tutorialTextValue = "Right now you are at the first page of your very own virtual storybook!"; break;
		case 2: tutorialTextValue = "Your basic details are over here at the right page of your book.";
		...
		case 3: tutorialBox.style.left = "23.2421875%";
				tutorialTextValue = "&nbsp;Tap this to upload your own picture!";
				...
				gradeArea.style.zIndex = 5555;
				hand.style.display = "none"; break;
		case 3: tutorialTextValue = photoText;
		...
		case 3: tutorialTextValue = "&nbsp;&nbsp;Tap this button to go to the next page.";
