...
import com.swiftshot.funimals.PictureEditorActivity;
...
import com.swiftshot.funimals.models.database.entities.IGCharacter;
...
public class StoryElement {
	...
	/**
	 * Keyword for the first concept used in the {@link com.swiftshot.funimals.models.storyplanner.plot.StoryRandomizer}
	 */
	public static final String CONCEPT1 = "C1";
	/**
	 * Keyword for the second concept used in the {@link com.swiftshot.funimals.models.storyplanner.plot.StoryRandomizer}
	 */
	public static final String CONCEPT2 = "C2";
	/**
	 * Keyword for the location used in the {@link com.swiftshot.funimals.models.storyplanner.plot.StoryRandomizer}
	 */
	public static final String LOCPREP = "locPrep";
	/**
	 * Keyword for the previous agens used in the {@link com.swiftshot.funimals.models.storyplanner.plot.StoryRandomizer}
	 */
	public static final String PREVAGENS = "PrevAgens";
	/**
	 * Keyword for the previous patiens used in the {@link com.swiftshot.funimals.models.storyplanner.plot.StoryRandomizer}
	 */
	public static final String PREVPATIENS = "PrevPatiens";

	//for IntroMaker.java
	/**
	 * Keyword for the place relationship used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
	public static final String PLACE_REL = "locationOf";
	/**
	 * Keyword for the place category used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
	public static final String PLACE_CAT = "spatial";
	/**
	 * Keyword for the location relationship used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
	public static final String LOC_REL = "propertyOf";
	/**
	 * Keyword for the location category used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
	public static final String LOC_CAT = "things";
	/**
	 * Keyword for the time relationship used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
	public static final String TIME_REL = "conceptuallyRelatedTo";
	/**
	 * Keyword for the time category used in the {@link com.swiftshot.funimals.models.storyplanner.introduction.IntroMaker}
	 */
		...
		try{
			if(role.equalsIgnoreCase(ADULT)){
				...
				if(!dbMain.instantiateCharacter(mainChar.getMotherCharacterID()).getRole().equalsIgnoreCase(ICR.getBackground().getRequiredRole()))
					...
					searchedChar = PictureEditorActivity.adultChar;
